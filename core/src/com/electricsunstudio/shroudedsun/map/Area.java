...
import com.electricsunstudio.shroudedsun.DisjointNode;
import com.electricsunstudio.shroudedsun.Game;
import com.electricsunstudio.shroudedsun.objects.GameObject;
import com.electricsunstudio.shroudedsun.objects.circuit.CircuitGraph;
import com.electricsunstudio.shroudedsun.objects.circuit.LogicGateTorch;
import com.electricsunstudio.shroudedsun.objects.circuit.Wire;
...
public class Area
{
	...
	public AreaState save()
	{
		...
		for(GameObject go : Game.inst.gameObjectSystem.getObjects())
		{
		...
		for(GameObject go : Game.inst.gameObjectSystem.getObjects())
		{
                    if(go instanceof TreasureChest)
                    {
